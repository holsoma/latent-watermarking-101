# SERUM implementation lab

This lab keeps the initial-noise mark but adds an image-space detector path, so verification does not require inversion. The default run is a deterministic local adapter; paper-scale detector training remains separate.

Official implementation: https://github.com/Hubizon/SERUM

```bash
cd /c/amos/research/latent-watermarking-101/implementations/serum
