...
def main():
    ...
    print(json.dumps({"paper_slug":"gaussian-shannon","message":message,"recovered":recovered,"bit_error_rate":bit_error(message,recovered),"exact":message==recovered},indent=2))
