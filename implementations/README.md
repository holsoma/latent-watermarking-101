...
The four current labs use this structure while retaining their different research boundaries: HiDDeN trains an encoder and decoder, RoSteALS trains a latent offset path around a frozen autoencoder, Stable Signature fine-tunes a decoder against a fixed key, and ZoDiac optimises one latent per image.
