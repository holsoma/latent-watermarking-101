# PRC Watermark implementation lab

This lab demonstrates pseudorandom coding over an initial Gaussian mark and records detector evidence separately from the code path.

Official implementation: https://github.com/THU-BPM/MarkDiffusion

```bash
cd /c/amos/research/latent-watermarking-101/implementations/prc-watermark
